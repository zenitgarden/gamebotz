                  ...
                  <form action="{{route('users.update',['user'=>$user])}}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <input type="text" id="input_user_name" name="name" value="{{old('name',$user->name)}}" 
                            class="form-control @error('name') is-invalid @enderror" placeholder="Enter name"  @if(Auth::user()->name == $user->name)@else readonly @endif>
                            @error('name')
                        ...
                        {{-- Email --}}
                        <div class="col-sm-12 col-md-7">
                            <input type="email" id="input_user_email" name="email" value="{{old('email',$user->email)}}"
                             class="form-control @error('email') is-invalid @enderror" placeholder="Enter email" readonly>
                            @error('email')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            {{-- Role --}}
                            <div class="col-sm-12 col-md-7">
                                <select id="select-2" name="role" @if(Auth::user()->username != "Super Admin") disabled @endif
