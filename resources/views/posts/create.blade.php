    ...
    <div class="section-header">
      ...
      <div class="section-header-button">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item active"><a href="{{route('posts.index')}}">Posts</a></div>
               ...
               {{-- Title --}}
                <div class="form-group">
                        ...
                        <div class="col-md-12">
                            ...
                            @enderror" name="title" id="title" value="{{old('title')}}" placeholder="Enter Title">
                            @error('title')
               ...
               {{-- Slug --}}
                <div class="form-group">
                        ...
                        <div class="col-md-12 col-md-12">
                            ...
                            @enderror" name="slug" id="slug" value="{{old('slug')}}" readonly="" placeholder="Auto generate">
                            @error('slug')
                              <div class="invalid-feedback">
                                    {{$message}}
                              </div>
            ...
            {{-- Status --}}
              <div class="form-group">
                <div class="section-title col-md-12">Status Post</div>
                  <div class="custom-control custom-radio">
                    ...
                    @error('status') is-invalid @enderror" @if (old('status') == $status[1]) checked @endif value="{{$status[1]}}">
              ...
              <div class="custom-control custom-radio">
                  <div class="col-md-12">
                    ...
                    @error('status') is-invalid @enderror" @if (old('status') == $status[0]) checked @endif value="{{$status[0]}}">
              ...
              <div class="form-group">       
                <div class="col-md-12">
                   *Make sure all complete before save.
