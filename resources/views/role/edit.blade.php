...
<section class="section">
  <div class="section-header">
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item active"><a href="{{route('roles.index')}}">Role</a></div>
        ...
        <div class="card ">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
                ...
                @error('name') is-invalid @enderror"  placeholder="Enter role name" @if ($role->name == "Admin") readonly @endif>
                @error('name')
                      ...
                      <ul class="list-group mx-1 my-1" style="width: 220px;">
                         ...
                         <li class="list-group-item">
                             <div class="form-check" >
                                ...
                                {{in_array($p,old('permissions',$permissionChecked)) ? "checked" : null }}>
