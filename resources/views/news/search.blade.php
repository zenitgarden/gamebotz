...
@section('title')
You Searched for {{request()->get('s')}} - Gamebotz
@endsection
          ...
          <div class="row">
            <div class="col-sm-8 ">
              <h1 class="font-weight-600 ">
                Search result for "{{request()->get('s')}}"
              </h1>
            </div>
          </div>
          <div class="row">
            <div class="col-lg-8">
                <form class="input-group my-1 mb-4" action="{{route('news.search')}}" method="GET">
                    <input type="text" class="form-control" name="s" placeholder="Search...." value="{{request()->get('s')}}">
            ...
            @forelse ($posts as $post)
              ...
              @empty
              <div class="post-comment-section" style="border-top:0px; margin-top: 0px; padding-top: 0px; background-color: #e6e7e8">
