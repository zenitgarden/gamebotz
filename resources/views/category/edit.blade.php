    ...
    <section class="section">
      <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
          ...
          <div class="breadcrumb-item">{{$category->title}}</div>
        </div>
      </div>
                ...
                <div class="col-12">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <input type="text" id="input_title_category" name="title" value="{{old('title', $category->title)}}" 
                            class="form-control @error('title') is-invalid @enderror" placeholder="Enter category" >
                            @error('title')
                        ...
                        <div class="col-sm-12 col-md-7">
                            <input type="text" id="input_slug_category" name="slug" value="{{old('title', $category->slug)}}" 
                        ...
                        <div class="col-sm-12 col-md-7">
                            <select id="select-2-category" name="parent_category" style="clear:both;" class="form-control select2" data-placeholder="Choose parent category">
